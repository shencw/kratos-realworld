...
func RegisterRealWorldHTTPServer(s *http.Server, srv RealWorldHTTPServer) {
	...
	r.GET("/api/user", _RealWorld_UpdateUser0_HTTP_Handler(srv))
...
func _RealWorld_DeleteComment0_HTTP_Handler(srv RealWorldHTTPServer) func(ctx http.Context) error {
	return func(ctx http.Context) error {
		...
		h := ctx.Middleware(func(ctx context.Context, req interface{}) (interface{}, error) {
			return srv.DeleteComment(ctx, req.(*DeleteCommentsRequest))
		})
		out, err := h(ctx, &in)
		if err != nil {
			return err
...
func (c *RealWorldHTTPClientImpl) CreateArticle(ctx context.Context, in *CreateArticleRequest, opts ...http.CallOption) (*MultipleArticlesReply, error) {
...
func (c *RealWorldHTTPClientImpl) DeleteComment(ctx context.Context, in *DeleteCommentsRequest, opts ...http.CallOption) (*emptypb.Empty, error) {
