...
func (c *realWorldClient) CreateArticle(ctx context.Context, in *CreateArticleRequest, opts ...grpc.CallOption) (*MultipleArticlesReply, error) {
	out := new(MultipleArticlesReply)
...
func (c *realWorldClient) DeleteComment(ctx context.Context, in *DeleteCommentsRequest, opts ...grpc.CallOption) (*emptypb.Empty, error) {
...
func (UnimplementedRealWorldServer) CreateArticle(context.Context, *CreateArticleRequest) (*MultipleArticlesReply, error) {
...
func (UnimplementedRealWorldServer) DeleteComment(context.Context, *DeleteCommentsRequest) (*emptypb.Empty, error) {
...
func _RealWorld_DeleteComment_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(RealWorldServer).DeleteComment(ctx, req.(*DeleteCommentsRequest))
	}
	return interceptor(ctx, in, info, handler)
}
